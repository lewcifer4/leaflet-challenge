...
// Create a function to set the size of the marker based off the magnitude 
function markerSize(magnitude) {
return magnitude * 4;
}

// markerColor() function sets the colour of the marker based off the magnitude
...
function createFeatures(earthquakeData) {
    ...
    // Run the onEachFeature function for each data
